...
class SicossReporteExport implements WithMultipleSheets
{
    ...
    public function __construct(protected string $anio, protected string $mes, protected ?Collection $records = null, ?array $totales = null)
    {
    ...
    {
        $detalleSheet = new class ($this->anio, $this->mes, $this->records, $this->sicossReporteService) implements
            FromCollection,
            ShouldAutoSize,
            WithBackgroundColor,
            ...
            WithMapping,
            WithStyles,
            WithTitle { // phpcs:ignore PSR12.Classes.AnonClassDeclaration.OpenBraceSameLine -- CS Fixer coloca la llave aquí
            use Exportable;
            ...
            {
                if ($this->records instanceof \Illuminate\Support\Collection) {
                    return $this->records->map(fn($item): \App\Data\Responses\SicossReporteData => SicossReporteData::fromModel($item));
                }
        ...
        return [
            ...
            'Totales' => new class ($this->totales) implements FromCollection, ShouldAutoSize, WithBackgroundColor, WithColumnFormatting, WithCustomStartCell, WithHeadings, WithStyles, WithTitle {
                ...
                public function __construct(protected SicossTotalesData $totales) {}
