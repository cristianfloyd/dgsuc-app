...
class SicossLegajoProcessorRepository implements SicossLegajoProcessorRepositoryInterface
{
    ...
    protected function generarLineaSicoss(array $legajo): string
    {
        ...
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['PorcAporteDiferencialJubilacion'] ?? 0, 2, '', ''), 5
        );
        ...
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['IMPORTE_BRUTO'] ?? 0, 2, '', ''), 12
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['IMPORTE_IMPON'] ?? 0, 2, '', ''), 12
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['AsignacionesFliaresPagadas'] ?? 0, 2, '', ''), 9
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['IMPORTE_VOLUN'] ?? 0, 2, '', ''), 9
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['IMPORTE_ADICI'] ?? 0, 2, '', ''), 9
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteSACOtroAporte'] ?? 0, 2, '', ''), 9
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteSACOtraActividad'] ?? 0, 2, '', ''), 9
        );
        ...
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteImponiblePatronal'] ?? 0, 2, '', ''), 12
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteBrutoOtraActividad'] ?? 0, 2, '', ''), 12
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteImponible_4'] ?? 0, 2, '', ''), 12
        );
        ...
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['recompensamrl'] ?? 0, 2, '', ''), 9
        );
        $linea .= $legajo['tipoempresa'] ?? '0';
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['AporteAdicionalObraSocial'] ?? 0, 2, '', ''), 9
        );
        ...
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteSueldoMasAdicionales'] ?? 0, 2, '', ''), 12
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteSAC'] ?? 0, 2, '', ''), 12
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteHorasExtras'] ?? 0, 2, '', ''), 12
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteZonaDesfavorable'] ?? 0, 2, '', ''), 12
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteVacaciones'] ?? 0, 2, '', ''), 12
        );
        ...
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteImponible_5'] ?? 0, 2, '', ''), 12
        );
        $linea .= $legajo['trabajadorconvencionado'] ?? '0';
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteImponible_6'] ?? 0, 2, '', ''), 12
        );
        $linea .= $legajo['TipoDeOperacion'] ?? '0';

        // 11. Conceptos adicionales (12 + 12 + 12 + 12 + 3 + 12 = 63 caracteres)
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteAdicionales'] ?? 0, 2, '', ''), 12
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImportePremios'] ?? 0, 2, '', ''), 12
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['Remuner78805'] ?? 0, 2, '', ''), 12
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteSICOSS27430'] ?? 0, 2, '', ''), 12
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes($legajo['CantidadHorasExtras'] ?? '0', 3);
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteNoRemun'] ?? 0, 2, '', ''), 12
        );

        // 12. Conceptos especiales (12 + 9 + 12 + 9 = 42 caracteres)
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteMaternidad'] ?? 0, 2, '', ''), 12
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteRectificacionRemun'] ?? 0, 2, '', ''), 9
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['importeimponible_9'] ?? 0, 2, '', ''), 12
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ContribTareaDif'] ?? 0, 2, '', ''), 9
        );
        ...
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteSICOSSDec56119'] ?? 0, 2, '', ''), 12
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['IncrementoSolidario'] ?? 0, 2, '', ''), 12
        );
        $linea .= $this->sicossFormateadorRepository->llenaImportes(
            number_format($legajo['ImporteImponible_6'] ?? 0, 2, '', ''), 12
        );
