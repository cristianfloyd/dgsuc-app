...
class CuilRepository implements CuilRepositoryInterface
{
     ...
     * @return \Illuminate\Pagination\LengthAwarePaginator Paginador de los CUIL que no se encuentran en la tabla afip_mapuche_mi_simplificacion
     */
    public function getCuilsNotInAfip($perPage = 10): LengthAwarePaginator
    {
