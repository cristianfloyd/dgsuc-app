...
class CachingSicossReporteRepository implements SicossReporteRepositoryInterface
{
    ...
    public function getReporte(string $anio, string $mes): Collection
    {
        ...
        return $this->rememberReportCache(
            ...
            $cacheType,
            $cacheKeyParams,
            fn(): \Illuminate\Support\Collection => $this->decoratedRepository->getReporte($anio, $mes),
            self::CACHE_TTL,
        );
    }
    ...
    public function getTotales(string $anio, string $mes): array
    {
        ...
        return $this->rememberReportCache(
            ...
            $cacheType,
            $cacheKeyParams,
            fn(): array => $this->decoratedRepository->getTotales($anio, $mes),
            self::CACHE_TTL,
        );
    }
    ...
    public function existenDatosParaPeriodo(string $anio, string $mes): bool
    {
        ...
        return $this->rememberReportCache(
            ...
            $cacheType,
            $cacheKeyParams,
            fn(): bool => $this->decoratedRepository->existenDatosParaPeriodo($anio, $mes),
            self::CACHE_TTL,
        );
    }
    ...
    public function getPeriodosFiscalesDisponibles(): Collection
    {
        ...
        return $this->rememberReportCache(
            ...
            $cacheType,
            $cacheKeyParams,
            fn(): \Illuminate\Support\Collection => $this->decoratedRepository->getPeriodosFiscalesDisponibles(),
            $longTtl,
        );
    }
