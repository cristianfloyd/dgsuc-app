...
class TobaHashAdapter
{
    ...
    /**
     * Constructor de la clase TobaHashAdapter.
     *
     * Inicializa el adaptador hash con el método de hash especificado y la configuración de rondas.
     *
     * @param string $metodo El algoritmo hash a utilizar. El valor predeterminado es 'bcrypt'.
     * @param int $rounds El número de rondas del algoritmo hash. El valor predeterminado es self::MIN_ROUNDS.
     */
