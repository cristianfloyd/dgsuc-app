...
class AfipRelacionesActivasData extends Data
{
    public function __construct(
        ...
        public readonly string $fechaInicioRelacionLaboral,
        public readonly ?string $fechaFinRelacionLaboral,
        public readonly ?string $codigoOSocial,
        public readonly ?string $codSituacionBaja,
        public readonly ?string $fechaTelegramaRenuncia,
        public readonly string $retribucionPactada,
