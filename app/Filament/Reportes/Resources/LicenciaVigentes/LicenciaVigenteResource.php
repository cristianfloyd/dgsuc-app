...
class LicenciaVigenteResource extends Resource
{
                ...
                Action::make('consultar_legajos')
                    ...
                    ->action(function (array $data, Action $action): void {
                        try {
                            ...
                            // Registrar para depuración
                            Log::info('Legajos específicos cargados en sesión', [
                                'legajos' => $legajos,
                            ]);
                            ...
                            Log::error('Error al consultar legajos específicos', [
                                'error' => $e->getMessage(),
    ...
    public static function getPages(): array
    {
        ...
        return [
            'index' => ListLicenciaVigentes::route('/'),
        ];
    }
