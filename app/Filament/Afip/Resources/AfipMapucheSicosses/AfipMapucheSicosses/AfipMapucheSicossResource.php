...
class AfipMapucheSicossResource extends Resource
{
    ...
    {
        return [
            'index' => ListAfipMapucheSicosses::route('/'),
            'create' => CreateAfipMapucheSicoss::route('/create'),
            'import' => ImportAfipMapucheSicoss::route('/import'),
            'export' => ExportAfipMapucheSicoss::route('/export'),
        ];
    }
