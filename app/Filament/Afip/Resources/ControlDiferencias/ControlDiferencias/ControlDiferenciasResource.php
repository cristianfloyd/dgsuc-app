...
class ControlDiferenciasResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->recordActions([
                EditAction::make(),
                Action::make('buscarCombinaciones')
    ...
    {
        return [
            'index' => ListControlDiferencias::route('/'),
            'create' => CreateControlDiferencias::route('/create'),
            'edit' => EditControlDiferencias::route('/{record}/edit'),
        ];
    }
}
