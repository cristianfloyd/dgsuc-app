...
class TodoPolicy
{
    ...
    {
        return $user->checkPermissionTo('delete-any Todo');
    }
    ...
    {
        return $user->checkPermissionTo('restore Todo');
    }
    ...
    {
        return $user->checkPermissionTo('restore-any Todo');
    }
    ...
    {
        return $user->checkPermissionTo('reorder Todo');
    }
    ...
    {
        return $user->checkPermissionTo('force-delete Todo');
    }
    ...
    {
        return $user->checkPermissionTo('force-delete-any Todo');
    }
}
