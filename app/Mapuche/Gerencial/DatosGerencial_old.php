...
//						" . $map_esquema . ".map_get_edad('{$fecha}'::DATE, dh01.fec_nacim) AS cant_anios,
...
//				FROM
//					datos_base_dh21 db
//					JOIN " . $map_esquema . ".dh01 dh01 ON (dh01.nro_legaj = db.nro_legaj)
//					INNER JOIN " . $map_esquema . ".dh03 dh03 ON (dh03.nro_legaj = db.nro_legaj AND dh03.nro_cargo = db.nro_cargo)
//					LEFT OUTER JOIN " . $map_esquema . ".dh11 ON (dh11.codc_categ = db.codc_categ)
//					LEFT OUTER JOIN " . $map_esquema . ".dh31 ON (dh31.codc_dedic = dh11.codc_dedic)
...
//					LEFT OUTER JOIN " . $map_esquema . ".dh01_nomelegido ON (dh01.nro_legaj = dh01_nomelegido.nro_legaj)
//				ORDER BY
