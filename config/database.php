...
return [
    ...
    'connections' => [
        ...
        /*
        | pgsql = conexión principal (se puede escribir en entorno real).
        | En tests (APP_ENV=testing) usamos sqlite en memoria por defecto para no tocar la BD real.
        ...
        */
        ...
        /*
        | test-pgsql: BD demo para tests que necesiten escribir datos tipo Mapuche.
        | Definir en .env (TEST_PGSQL_*) cuando la BD demo exista; si no está definida, no usar en tests.
        */
        'test-pgsql' => [
            'driver' => 'pgsql',
            'host' => env('TEST_PGSQL_HOST', '127.0.0.1'),
            'port' => env('TEST_PGSQL_PORT', '5432'),
            'database' => env('TEST_PGSQL_DATABASE', 'mapuche_demo'),
            'username' => env('TEST_PGSQL_USERNAME', 'postgres'),
            'password' => env('TEST_PGSQL_PASSWORD', ''),
            'charset' => env('TEST_PGSQL_CHARSET', 'UTF8'),
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => env('TEST_PGSQL_SEARCH_PATH', 'mapuche,suc'),
            'sslmode' => 'prefer',
        ],
        ...
        'pgsql-prod' => [
            'driver' => 'pgsql',
            'url' => env('DB_URL'),
            'host' => env('DB7_HOST', env('DB5_HOST', '127.0.0.1')),
            'port' => env('DB7_PORT', env('DB5_PORT', '5436')),
            'database' => env('DB7_DATABASE', env('DB5_DATABASE', 'mapuche')),
            'username' => env('DB7_USERNAME', env('DB5_USERNAME', 'postgres')),
            'password' => env('DB7_PASSWORD', env('DB5_PASSWORD', '1234')),
            'charset' => 'SQL_ASCII',
            'collate' => 'UTF8',
            'client_encoding' => 'UTF8',
            'prefix' => '',
        ...
        'pgsql-test' => [
            ...
            'host' => env('DB_TEST_HOST', '127.0.0.1'),
            'port' => env('DB_TEST_PORT', '5432'),
            'database' => env('DB_TEST_DATABASE', 'liqui_test'),
            'username' => env('DB_TEST_USERNAME', 'postgres'),
