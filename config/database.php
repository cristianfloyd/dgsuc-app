    ...
    */
    ...
    'connections' => [
        ...
        'pgsql' => [
            ...
            'database' => env('DB_DATABASE', 'suc_app'),
            'username' => env('DB_USERNAME', 'postgres'),
            'password' => env('DB_PASSWORD', '1234'),
            'charset' => env('DB_CHARSET', 'utf8'),
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => env('DB_SCHEMA', 'informes_app') . ',public',
            'sslmode' => 'prefer',
        ],
        ...
        'pgsql-liqui-old' => [
            'driver' => 'pgsql',
            'host' => env('DB_TEST_R2_HOST', '127.0.0.1'),
            'port' => env('DB_TEST_R2_PORT', '5432'),
            'database' => env('DB_TEST_R2_DATABASE', 'liqui'),
            'username' => env('DB_TEST_R2_USERNAME', 'postgres'),
            'password' => env('DB_TEST_R2_PASSWORD', '1234'),
            'charset' => 'SQL_ASCII',
            'client_encoding' => 'UTF8',
        ...
        'pgsql-prod-old' => [
            ...
            'database' => env('DB_PROD_DATABASE', 'liqui'),
        ...
        'pgsql-prod' => [
            ...
            'port' => env('DB7_PORT', '5432'),
            'database' => env('DB7_DATABASE', 'liqui'),
        ...
        'pgsql-consulta' => [
            ...
            'database' => env('DB8_DATABASE', 'liqui'),
