    ...
    */
    ...
    'connections' => [
        ...
        'pgsql-mapuche' => [
            ...
            'database' => env('DB2_DATABASE', 'desa'),
        ...
        'pgsql-2503' => [
            ...
            'port' => env('DB3_PORT', '5433'),
            'database' => env('DB6_DATABASE', 'laravel'),
            'username' => env('DB3_USERNAME', 'postgres'),
        ...
        'pgsql-prod' => [
            ...
            'database' => env('DB5_DATABASE', 'liqui'),
            'username' => env('DB5_USERNAME', 'postgres'),
            'password' => env('DB5_PASSWORD', 'postgres'),
            'charset' => 'SQL_ASCII',
            'collate' => 'UTF8',
            'client_encoding' => 'UTF8',
            'prefix' => '',
