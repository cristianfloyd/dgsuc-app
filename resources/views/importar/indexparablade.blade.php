                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('importar.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="modelo" class="form-control @error('modelo') is-invalid @enderror" name="modelo" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="archivo" class="form-control @error('archivo') is-invalid @enderror" name="archivo" required>
                                        @foreach ($archivos as $archivo)
                                            <option value="{{ $archivo->original_name }}">{{ $archivo->filename }}</option>
                                        @endforeach
                                    </select>
