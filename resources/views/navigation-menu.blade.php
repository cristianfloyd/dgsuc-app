    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Nuevo Dropdown Container con las rutas que faltan-->
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 focus:outline-none focus:text-gray-700 transition ease-in-out duration-150">
                                <div>
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="{{ route('compare-cuils') }}" :active="request()->routeIs('compare-cuils')">
                                {{__('Compare Cuils')}}
                            </x-dropdown-link>
                            <x-dropdown-link href="{{ route('buscar-columna') }}" :active="request()->routeIs('buscar-columna')">
                                {{__('Buscar Columna')}}
                            </x-dropdown-link>
                            <x-dropdown-link href="{{ route('buscar-comentario') }}" :active="request()->routeIs('buscar-comentario')">
                                {{__('Buscar Comentario')}}
                            </x-dropdown-link>
                            ...
                            <x-dropdown-link href="{{ route('dh21') }}" :active="request()->routeIs('dh21')">
                                {{__('DH21')}}
                            </x-dropdown-link>
                            ...
                            <form method="POST" action="{{ route('logout') }}" x-data="{ loading: false }">
                                ...
                                >
                                    <div class="flex items-center">
                                        <span x-show="!loading">{{ __('Log Out') }}</span>
